...
my_parser.add_argument('--data_root', type=str, default='/media/SSD/Frame_Inter_rheology2023/dataset/_5Frame/', help='path to text files')
my_parser.add_argument('--root2save', type=str, default='/media/SSD/Frame_Inter_rheology2023/dataset/_5FrameFilter/', help='path to save new file text')
...
for fn in data_fn:
    ...
    for seq in meta_data:
        ...
        trainlist0.append([img1_path,img2_path,img3_path,img4_path, img5_path])
        #time.sleep(0.01)
